      ...
      <div className="">
        <div className="d-flex justify-content-around p-0 px-sm-5 mx-5 flex-wrap">
          ...
          >
            ...
            <div className="card-block text-center">
              <h5 className="card-title text-warning ">Ivania Lebrón</h5>
          ...
          >
            ...
            />
            <div className="card-block text-center">
              <h5 className="card-title  text-warning ">Luciana Munguía</h5>
              <p className="card-text">Developer & Designer</p>
              <h6 className="card-text mb-3 ">El Salvador, San Salvador</h6>
            </div>
          </div>
          ...
          >
            ...
            />
            <div className="card-block text-center">
              <h5 className="card-title  text-warning ">Andrea Velásquez</h5>
              <p className="card-text">Developer & Designer</p>
              <h6 className="card-text  mb-3">El Salvador, San Salvador</h6>
            </div>
          </div>
        ...
        <div className="d-flex justify-content-around p-0 px-sm-5 mx-5 mt-4 flex-wrap">
          ...
          >
            ...
            />
            <div className="card-block text-center">
              <h5 className="card-title text-warning ">Giovana Anaya</h5>
              <p className="card-text">Developer & Designer</p>
              <h6 className="card-text  mb-3">El Salvador, San Salvador</h6>
            </div>
          </div>
          ...
          >
            ...
            />
            <div className="card-block text-center">
              <h5 className="card-title  text-warning ">Fernando Montano</h5>
              <p className="card-text">Developer & Designer</p>
