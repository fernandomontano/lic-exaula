          ...
          <div className=" card border-secondary mb-3">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                sus cálculos convirtiendo de una moneda a otra de manera
                sencilla y rápida. Este conversor cuenta con los valores
                actualizados de las principales monedas del mundo. Los valores
                de las diferentes monedas se determinan en función de la oferta
                o la demanda de precios de negociación entre bancos
                internacionales.
              </p>
            </div>
          </div>
